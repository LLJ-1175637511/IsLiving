...
@Database(entities = [SuppleDoing::class, SuppleFinished::class,OldManInfoWait::class,OldManInfoHad::class,CheckDoing::class,OldManInfoCheckHad::class], version = 1, exportSchema = false)
